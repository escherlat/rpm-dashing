...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/opt/dashing/vendor/bundle/ruby/1.9.1/gems/nokogiri-1.6.1/ports/x86_64-redhat-linux/libxslt/1.1.26/lib/libxslt-plugins"
#endif
